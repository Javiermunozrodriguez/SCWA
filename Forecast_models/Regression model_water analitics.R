...
#pasamos a desarrollar la regresion lineal de la varaible Como primer argumento de lm se coloca la fórmula variable dependiente ~ variable independiente. 
...
#vamos a hacer un comparación de metricas entre las dos estrategias para elegir modelo de ARIMA
...
#trabajamos en dstintas versiones del modelo ariam par encontrar la que más se ajuste a la serie 
...
# realizamos el teste y el train para la primera serie de usuario número 01
...
# el modelo elegido para aplicar será el "ARIMA(2,1,2)(1,0,0)[12]", basadonos en l aestrategia testada aquí y en experiencias de resolion previas
# con series temporales, donde las metrica apuntas menores errores resduales por tanto se espera un notable precisión:
